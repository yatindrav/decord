...
class AudioReader(object):
    ...
    def __init__(self, uri, ctx=cpu(0), sample_rate=-1, mono=True):
        ...
        sr = _CAPI_AudioReaderGetOriginalSampleRate(self._handle)
        self.sample_rate =  sr if sr != None else sample_rate
    ...
    def get_original_sample_rate(self):
        ...
        self.sample_rate =  _CAPI_AudioReaderGetOriginalSampleRate(self._handle)
